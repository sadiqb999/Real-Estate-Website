<header class="header">
   ...
   <a href="dashboard.php" class="logo">Agent Panel.</a>
   ...
   <a href="../components/agent_logout.php" onclick="return confirm('logout from this website?');" class="delete-btn"><i class="fas fa-right-from-bracket"></i><span>Log Out</span></a>
